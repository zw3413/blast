...
def generate_detections(encoder, mot_dir, output_dir, detection_dir=None):
    ...
    for sequence in os.listdir(mot_dir):
        if 'FRCNN' not in sequence: continue  # dyh
        ...
        detection_file = os.path.join('/data/dyh/results/StrongSORT/Detection/YOLOX_ablation_nms.8_score.1', '{}.txt'.format(sequence))  # dyh
