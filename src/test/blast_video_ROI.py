...
def roi_video(input_path, output_path):
    ...
    while video.is_cap_opended():
        ...
        if object_bounding_box is None:
            ...
            object_bounding_box = clip_bounding_box( tuple( np.array(object_bounding_box) + np.array((-20, -20, 40, 40)) ), video.width, video.height)
...
if __name__ == "__main__":
    path = "./temp/123/340_102_clipped_StabilizeV.mp4"
    output = "./temp/123/340_102_clipped_StabilizeV_ROI.mp4"
